 ...
 * @usage
 * ```
 * import { customPlugin } from 'ionic-native';
 *
 * customPlugin.functionName('Hello', 123)
...
__decorate([
    plugin_1.Cordova()
], CustomPlugin, "xxx", null);
CustomPlugin = __decorate([
    plugin_1.Plugin({
        pluginName: 'CustomPlugin',
        plugin: 'cordova-plugin-customPlugin',
